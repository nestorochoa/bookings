...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<link href="<?php echo base_url() ?>front/css/bootstrap-timepicker.min.css" rel="stylesheet" type="text/css"/>
	<link href="<?php echo base_url() ?>front/css/calendar.css" rel="stylesheet" type="text/css"/>
	<link href="<?php echo base_url() ?>front/css/ui-lightness/jquery-ui-1.10.3.custom.min.css" rel="stylesheet" type="text/css"/>
	

	<script type="text/javascript" src="<?php echo base_url() ?>front/js/jquery-1.10.2.min.js"></script>
	<script src="<?php echo base_url() ?>front/js/jquery-ui-1.10.3.custom.min.js"></script>
	<script type="text/javascript" src="<?php echo base_url() ?>front/js/jquery.ui.touch-punch.min.js"></script>
	...
	<div class="container">
		...
		<?php include('include/booking_m.inc.php')?>
	</div>

    <script>
    var userType = "<?php echo $typeUser ?>";
    </script>
</body>

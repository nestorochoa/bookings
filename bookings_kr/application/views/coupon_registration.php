...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<script src="<?php echo base_url() ?>front/js/bootstrap.validate.js"></script>
	<script src="<?php echo base_url() ?>front/js/bootstrap.validate.en.js"></script>
	...
	<![endif]-->
    <div class="container">
    	<div class="span8" style="text-align:center;margin-top: 20px;    margin-bottom: 20px;">
        	<img src="<? echo base_url() ?>front/img/logo.png" alt="<? echo $config_var['company_name']?>" width="100%" style="max-width:150px;" />
        </div>
    
        <div class="span8 well">
            <?php include('include/user_details_coupon.inc.php')?>
        </div>
	</div>
